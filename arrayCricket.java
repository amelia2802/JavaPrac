    ...
    public static void main(String[] args){
        ...
        for(int i = 0;i<scores.length;i++){
            if(scores[i] >= 200) { //if score is greater than or equals to 200
				result[2]++; //Same as results[2] = results[2] + 1;
        ...
        System.out.println("No of half-centuries: "+result[0]);
        System.out.println("No of full-centuries: "+result[1]);
        System.out.println("No of double-centuries: "+result[2]);
    }
}
